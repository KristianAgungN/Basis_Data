...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2026 at 11:05 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tambah_transaksi` (`p_id_pelanggan` INT, `p_id_buku` INT, `p_jumlah` INT)   BEGIN
    ...
    IF v_stok < p_jumlah THEN
        SELECT 'Stok buku tidak mencukupi' AS pesan;
    ELSE
...
(1, 'Bumi', 'Tere Liye', 85000.00, 50),
(2, 'Laskar Pelangi', 'Andrea Hirata', 75000.00, 30),
(3, 'Atomic Habits', 'James Clear', 120000.00, 3),
(4, 'Rich Dad Poor Dad', 'Robert Kiyosaki', 95000.00, 15);
...
(1, 'Andi Wijaya', 1200000.00, 'GOLD'),
(2, 'Siti Rahayu', 0.00, 'REGULER'),
(3, 'Budi Santoso', 0.00, 'REGULER');
...
(1, 1, 3, 3, 360000.00, '2026-06-21'),
(2, 1, 3, 7, 840000.00, '2026-06-21'),
(3, 1, 3, 7, 840000.00, '2026-06-21');
